...
from ingestion.mdx_image_refs import ImageRef, extract_relative_image_refs
...
def _images_on_line(line: str) -> List[ImageRef]:
    refs = extract_relative_image_refs(line)
    # also catch lone <img> if not caught (extract_relative_image_refs handles img)
    return refs
