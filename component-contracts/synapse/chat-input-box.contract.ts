...
export { SYNAPSE_SUGGESTED_PROMPT_MAIN_SET_NODE_ID as SYNAPSE_CHAT_INPUT_BOX_SUGGESTED_PROMPT_SET_NODE_ID } from "./suggested-prompt.contract";
...
/** @deprecated Import from `synapse-suggested-prompt.contract.ts`. */
export { SYNAPSE_SUGGESTED_PROMPT_VARIANT_NODES as SYNAPSE_CHAT_INPUT_BOX_SUGGESTED_PROMPT_NODES } from "./suggested-prompt.contract";
...
/** @deprecated Import from `synapse-suggested-prompt.contract.ts`. */
export { SYNAPSE_SUGGESTED_PROMPT_SAMPLE_LABEL as SYNAPSE_CHAT_INPUT_BOX_SAMPLE_PROMPT_LABEL } from "./suggested-prompt.contract";
