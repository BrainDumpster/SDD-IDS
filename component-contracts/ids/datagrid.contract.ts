 ...
 */
export const IDS_DATAGRID_DESIGN_SPEC_PATH = "components/ids/datagrid/design-spec.md" as const;

export type DatagridViewMode = "table" | "treeview";
export type DatagridSelectionMode = "single" | "multiple";

export interface DatagridColumnInput {
  key: string;
  title: string;
  minWidth?: number;
  width?: number;
...
export const DATAGRID_API_DEFAULTS = {
  viewMode: "table" as DatagridViewMode,
  rowSelection: false,
  selectionMode: "single" as DatagridSelectionMode,
...
export const DATAGRID_SPEC_COLUMNS: DatagridColumnInput[] = [
  {
    key: "name",
    title: "Name",
    sortable: true,
...
export const DATAGRID_SPEC_ROWS: DatagridRowInput[] = [
  {
    id: "r-1",
    values: {
