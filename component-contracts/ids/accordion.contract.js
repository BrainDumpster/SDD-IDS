 ...
 */
export const IDS_ACCORDION_DESIGN_SPEC_PATH = "components/ids/accordion/design-spec.md";
export const ACCORDION_CHEVRON_ICON_SLUG = "chev-down-thick";
export const ACCORDION_API_DEFAULTS = {
    multiple: false,
    chevronPosition: "left",
    variant: "default",
};
export const ACCORDION_SPEC_DEMO_ITEMS = [
    {
        value: "section1",
        title: "Network configuration",
        content: "Configure network policies and service endpoints for this workspace. Learn how network policies work in the admin guide.",
    },
    {
        value: "section2",
...
export const ACCORDION_SPEC_FORM_ITEMS = [
    {
        value: "form1",
...
export function assertAccordionItemValuesUnique(items) {
    const seen = new Set();
