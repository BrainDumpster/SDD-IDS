...
const _c0 = [[["ids-icon"]], "*"];
const _c1 = ["ids-icon", "*"];
const _c2 = (a0, a1, a2, a3) => ["ids-button", a0, a1, a2, a3];
...
function IdsButtonComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵclassProp("visually-hidden", ctx_r0.loading && ctx_r0.resolvedIconOnly);
} }
...
export class IdsButtonComponent {
    leadingIcon = contentChild(IdsIconComponent, ...(ngDevMode ? [{ debugName: "leadingIcon" }] : /* istanbul ignore next */ []));
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: IdsButtonComponent, selectors: [["ids-button"]], contentQueries: function IdsButtonComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            i0.ɵɵcontentQuerySignal(dirIndex, ctx.leadingIcon, IdsIconComponent, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance();
        } }, inputs: { variant: "variant", size: "size", disabled: "disabled", loading: "loading", iconOnly: "iconOnly", ariaLabel: "ariaLabel", type: "type" }, outputs: { clicked: "clicked" }, ngContentSelectors: _c1, decls: 4, vars: 12, consts: [[3, "click", "ngClass", "disabled"], ["aria-hidden", "true", 1, "spinner"], ["aria-hidden", "true", 1, "icon-slot", 3, "visually-hidden"], [1, "label", 3, "label-hidden"], ["aria-hidden", "true", 1, "icon-slot"], [1, "label"]], template: function IdsButtonComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵconditionalCreate(2, IdsButtonComponent_Conditional_2_Template, 2, 2, "span", 2);
            i0.ɵɵconditionalCreate(3, IdsButtonComponent_Conditional_3_Template, 2, 2, "span", 3);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction4(7, _c2, ctx.variantClass, ctx.size, ctx.resolvedIconOnly ? "icon-only" : "", ctx.loading ? "loading" : ""))("disabled", ctx.disabled || ctx.loading);
            i0.ɵɵattribute("type", ctx.type)("aria-label", ctx.resolvedIconOnly ? ctx.ariaLabel || null : null);
            i0.ɵɵadvance();
            i0.ɵɵconditional(ctx.loading ? 1 : -1);
            i0.ɵɵadvance();
            i0.ɵɵconditional(ctx.hasLeadingIcon ? 2 : -1);
            i0.ɵɵadvance();
            i0.ɵɵconditional(!ctx.resolvedIconOnly ? 3 : -1);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(IdsButtonComponent, { className: "IdsButtonComponent", filePath: "src/components/ids-button/ids-button.component.ts", lineNumber: 25 }); })();
