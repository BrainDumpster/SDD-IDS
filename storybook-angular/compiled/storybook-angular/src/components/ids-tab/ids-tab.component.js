...
import { TAB_API_DEFAULTS, TAB_OVERFLOW_MORE_ICON_SIZE_PX, TAB_OVERFLOW_MORE_ICON_SLUG, TAB_SPEC_ACCURATE_DEFAULTS, computeTabOverflowMenuItems, computeTabOverflowVisibleCount, } from "../../../../component-contracts/ids/tab.contract.js";
...
function IdsTabComponent_Conditional_6_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵproperty("shapeName", ctx_r2.moreIconSlug)("size", ctx_r2.moreIconSizePx);
    i0.ɵɵadvance();
...
export class IdsTabComponent {
    ...
    moreIconSlug = TAB_OVERFLOW_MORE_ICON_SLUG;
    moreIconSizePx = TAB_OVERFLOW_MORE_ICON_SIZE_PX;
    itemQuery;
    listWrapRef;
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(IdsTabComponent, { className: "IdsTabComponent", filePath: "src/components/ids-tab/ids-tab.component.ts", lineNumber: 46 }); })();
