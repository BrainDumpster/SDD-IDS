...
import { TAG_SPEC_ACCURATE_DEFAULTS, } from "../../../../component-contracts/ids/tag.contract.js";
...
function IdsTagComponent_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(ctx_r0.badgeCount);
} }
function IdsTagComponent_Conditional_2_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 7)(1, "span", 9);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
...
function IdsTagComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 3, 0)(2, "span", 4);
    i0.ɵɵconditionalCreate(3, IdsTagComponent_Conditional_2_Conditional_3_Template, 5, 1, "span", 7);
    i0.ɵɵelementStart(4, "span", 8);
    i0.ɵɵtext(5);
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵattribute("tabindex", ctx_r0.isEditableFocusable ? 0 : null);
    i0.ɵɵadvance(3);
    i0.ɵɵconditional(ctx_r0.showLabel ? 3 : -1);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r0.label);
} }
function IdsTagComponent_Conditional_3_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 7)(1, "span", 9);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "span", 10);
...
function IdsTagComponent_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵconditionalCreate(1, IdsTagComponent_Conditional_3_Conditional_1_Template, 5, 1, "span", 7);
...
function IdsTagComponent_Conditional_5_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function IdsTagComponent_Conditional_5_Template_button_click_0_listener($event) { i0.ɵɵrestoreView(_r2); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.onDismiss($event)); });
    i0.ɵɵnamespaceSVG();
...
export class IdsTagComponent {
    ...
    closable = TAG_SPEC_ACCURATE_DEFAULTS.closable;
    badgeCount = TAG_SPEC_ACCURATE_DEFAULTS.badgeCount;
    visualState = TAG_SPEC_ACCURATE_DEFAULTS.visualState;
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(IdsTagComponent, { className: "IdsTagComponent", filePath: "src/components/ids-tag/ids-tag.component.ts", lineNumber: 32 }); })();
