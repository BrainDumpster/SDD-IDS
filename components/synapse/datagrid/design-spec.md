...
|---|---|---|---|---|---|
| default | default | `var(--color-background-surface-primary)` (#f4f4f4) |  | `var(--color-icon-gray-neutral-base)` (#4d4d4d) |  |
| default | focus |  |  |  | focus-ring: `var(--border-width-border-2)` `var(--color-border-brand-base)`; radius: `var(--corner-radius-radius-2)` |
| default | hover | `var(--color-background-brand-lighter-slate)` (#ebf4fb) |  | `var(--color-text-brand-base)` (#0076ce) |  |
...
| Variant | State | Background | Border | Text / Icon | Other |
|---|---|---|---|---|---|
| default | default | `var(--color-background-surface-primary)` (#111619) |  | `var(--color-icon-gray-neutral-base)` (#b8c1c9) |  |
| default | focus |  |  |  | focus-ring: `var(--border-width-border-2)` `var(--color-border-brand-base)`; radius: `var(--corner-radius-radius-2)` |
| default | hover | `var(--color-background-brand-lighter-slate)` (#1e262c) |  | `var(--color-text-brand-base)` (#4c9fdd) |  |
