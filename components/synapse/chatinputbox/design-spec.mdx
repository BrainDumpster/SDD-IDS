...
| Variant | State | Background | Border | Text / Icon | Other |
|---|---|---|---|---|---|
| default | default | `var(--color-background-controls-brand-base)` (#0076ce) | `var(--border-width-border-1)` (1px) `var(--color-border-light)` (#34414c) | `var(--color-text-white)` (#ffffff) | opacity: 0.5; radius: `var(--corner-radius-radius-4)` |
| default | disabled |  |  |  | opacity: 0.4 |
