...
|---|---|---|---|---|---|
| default | default | `var(--color-background-controls-brand-base)` (#0076ce) | `var(--border-width-border-1)` (1px) `var(--color-border-light)` (#c5c5c5) | `var(--color-text-white)` (#ffffff) | opacity: 0.5; radius: `var(--corner-radius-radius-4)` |
