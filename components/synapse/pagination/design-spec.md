...
|---|---|---|---|---|---|
| default | default | `var(--color-background-controls-base)` (#0076ce) | `var(--color-background-controls-base)` (#0076ce) | `var(--color-text-gray-neutral)` (#4d4d4d) | radius: `var(--corner-radius-radius-4)` |
| default | disabled |  |  |  | opacity: 0.5 |
| default | focus |  |  |  | focus-ring: `var(--border-width-border-2)` `var(--color-border-brand-base)` |
| default | hover | `var(--color-background-controls-strong)` (#0062ab) | `var(--color-background-controls-strong)` (#0062ab) |  |  |
...
| Variant | State | Background | Border | Text / Icon | Other |
|---|---|---|---|---|---|
| default | default | `var(--color-background-controls-base)` (#0076ce) | `var(--color-background-controls-base)` (#0076ce) | `var(--color-text-gray-neutral)` (#b8c1c9) | radius: `var(--corner-radius-radius-4)` |
| default | disabled |  |  |  | opacity: 0.5 |
| default | focus |  |  |  | focus-ring: `var(--border-width-border-2)` `var(--color-border-brand-base)` |
| default | hover | `var(--color-background-controls-strong)` (#0062ab) | `var(--color-background-controls-strong)` (#0062ab) |  |  |
