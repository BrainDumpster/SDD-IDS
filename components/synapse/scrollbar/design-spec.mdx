...
|---|---|---|---|---|---|
| default | default | `var(--color-border-light)` (#c5c5c5) | `var(--border-width-border-1)` (1px) `var(--color-border-lighter)` (#eaeaea) |  | opacity: 0; radius: `var(--corner-radius-radius-4)` |
...
| Variant | State | Background | Border | Text / Icon | Other |
|---|---|---|---|---|---|
| default | default | `var(--color-border-light)` (#34414c) | `var(--border-width-border-1)` (1px) `var(--color-border-lighter)` (#1e262c) |  | opacity: 0; radius: `var(--corner-radius-radius-4)` |
