...
| error | default | `var(--color-background-alerting-critical-slate)` (#f3d9d9) |  | `var(--alert-red-500)` (#af0000) |  |
| info | default | `var(--color-background-alerting-info-slate)` (#d9e7f8) |  | `var(--alert-blue-500)` (#005ece) |  |
| success | default | `var(--color-background-alerting-success-slate)` (#ddedd9) |  | `var(--alert-green-500)` (#1b8500) |  |
| warning | default | `var(--alert-yellow-200)` (#fff7d9) |  | `var(--alert-yellow-800)` (#9c622e) |  |
...
| error | default | `var(--color-background-alerting-critical-slate)` (#1e262c) |  | `var(--alert-red-500)` (#af0000) |  |
| info | default | `var(--color-background-alerting-info-slate)` (#1e262c) |  | `var(--alert-blue-500)` (#005ece) |  |
| success | default | `var(--color-background-alerting-success-slate)` (#1e262c) |  | `var(--alert-green-500)` (#1b8500) |  |
| warning | default | `var(--alert-yellow-200)` (#fff7d9) |  | `var(--alert-yellow-800)` (#9c622e) |  |
