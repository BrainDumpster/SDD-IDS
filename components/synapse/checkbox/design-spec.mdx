...
| Unchecked | Focus-visible | `var(--color-background-component)` | `var(--color-border-brand-base)` + 3px focus ring | none | `var(--color-text-neutral-strong)` |
...
| Checked | Focus-visible | `var(--color-background-controls-brand-base)` | `var(--color-border-transparent-brand)` + 3px focus ring | check in `var(--color-icon-white)` | `var(--color-text-neutral)` |
...
| Indeterminate | Focus-visible | `var(--color-background-component)` | `var(--color-border-brand-base)` + 3px focus ring | dash in `var(--color-icon-brand-base)` | `var(--color-text-neutral)` |
