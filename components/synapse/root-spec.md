...
| `--color-background-brand-light-slate` | #d9eaf8 | #34414c |
...
| `--color-background-controls-base` | #0076ce | #0076ce |
| `--color-background-controls-light` | #d9eaf8 | #002642 |
| `--color-background-controls-lighter` | #ebf4fb | #003a65 |
| `--color-background-controls-strong` | #0062ab | #0062ab |
| `--color-background-controls-stronger` | #06528a | #06528a |
...
| `--color-background-masthead-base` | #0076ce | #1e262c |
| `--color-background-masthead-strong` | #0062ab | #34414c |
| `--color-background-masthead-stronger` | #06528a | #455666 |
...
| `--color-border-alerting-minor-base` | #9c622e | rgba(255,255,255,0.00) |
...
| `--color-border-brand-strong` | #0062ab | #94c5ea |
| `--color-border-brand-base-neutral` | #0076ce | #8898a5 |
...
| `--color-border-gray-neutral-base` | #4d4d4d | #8898a5 |
...
| `--color-border-brand-transparent-brand` | rgba(255,255,255,0.00) | #4c9fdd |
...
| `--color-text-alerting-major-strong` | #6d4028 | #6d4028 |
...
| `--color-icon-alerting-major-base` | #ed6400 | #f2934c |
...
| `--color-icon-gray-neutral-base` | #4d4d4d | #b8c1c9 |
| `--color-icon-gray-neutral-light` | #4d4d4d | #e6e9ec |
| `--color-icon-gray-neutral-strong` | #252525 | #f2f3f5 |
