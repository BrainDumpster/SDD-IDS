...
> Generated 2026-04-16T10:29:01Z. Global design system specification — framework-agnostic.
...
### Background Tokens (68 tokens)

| Token | Light | Dark |
|---|---|---|
| `--color-background-alerting-critical` | #af0000 | #dd9494 |
...
| `--color-background-alerting-major` | #ed6400 | #f7be94 |
| `--color-background-alerting-major-slate` | #fce8d9 | #1e262c |
| `--color-background-alerting-minor` | #ffc700 | #ffe794 |
...
| `--color-background-controls-brand-strong` | #0062ab | #34414c |
| `--color-background-controls-brand-stronger` | #06528a | #455666 |
...
### Icon Tokens (23 tokens)

| Token | Light | Dark |
|---|---|---|
| `--color-icon-accessible` | #757575 | #8898a5 |
| `--color-icon-alerting-critical` | #af0000 | #dd9494 |
| `--color-icon-alerting-minor-1` | #FFC700 | #FFC700 |
| `--color-icon-alerting-success-1` | #1b8500 | #9fcc94 |
