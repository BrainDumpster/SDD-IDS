...
> Generated 2026-03-25T01:42:04Z. Global design system specification — framework-agnostic.
...
| `--color-background-alerting-minor-slate` | None | #1e262c |
...
| `--color-background-component-light` | #f4f4f4 | #171d21 |
...
| `--color-background-gray-neutral-darker` | #252525 | #252525 |
...
### Border Tokens (48 tokens)

| Token | Light | Dark |
|---|---|---|
| `--color-border-accessible` | #757575 | #8898a5 |
| `--color-border-alerting-critical-base` | None | #dd9494 |
...
| `--color-border-alerting-info-base` | None | #94bbea |
...
| `--color-border-alerting-major-base` | None | #f7be94 |
...
| `--color-border-alerting-success-base` | None | #9fcc94 |
...
| `--color-icon-neutral-strong` | None | #f2f3f5 |
...
### Primitive Palette — UI & Secondary (58 tokens)
...
| `--shadow-drop-shadow-16-spread` | 0 | 0 |
| `--shadow-drop-shadow-16-x` | 0 | 0 |
...
| `--shadow-drop-shadow-2-spread` | 0 | 0 |
| `--shadow-drop-shadow-2-x` | 0 | 0 |
...
| `--shadow-drop-shadow-32-spread` | 0 | 0 |
| `--shadow-drop-shadow-32-x` | 0 | 0 |
...
| `--shadow-drop-shadow-4-spread` | 0 | 0 |
| `--shadow-drop-shadow-4-x` | 0 | 0 |
...
| `--shadow-drop-shadow-8-spread` | 0 | 0 |
| `--shadow-drop-shadow-8-x` | 0 | 0 |
...
- When a component requires an icon, generators must first look for an existing framework/library `Icon` component in the target codebase.
- Generators must inspect that `Icon` component API and use the real shape/name input prop (for example `name`, `icon`, `shape`, `glyph`) rather than assuming a fixed prop key.
- Icon lookup should prefer canonical design-spec icon names first, then declared fallbacks in component specs.
- Raw SVG/image fallback is allowed only when no compatible icon component or named icon is available.
