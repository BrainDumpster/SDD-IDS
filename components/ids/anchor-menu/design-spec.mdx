...
| Anchor Item (Default) | transparent | transparent | `var(--color-text-neutral)` (#8898a5) |
| Anchor Item (Hover) | transparent | transparent | `var(--color-text-brand-strong)` (#94c5ea) |
| Anchor Item (Focus) | transparent | `var(--color-border-brand-base)` (#4c9fdd) | `var(--color-text-brand-strong)` (#94c5ea) |
| Anchor Item (Active) | `var(--color-background-controls-brand-base)` (#0076ce) | `var(--color-background-controls-brand-base)` (#0076ce) | `var(--color-text-white)` (#ffffff) |
