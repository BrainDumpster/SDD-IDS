...
- Reference implementation: `storybook/src/components/RadioButton.tsx` (shared IDS / IDS-AI). Storybook matrices may use **single-option** groups per cell and per-option `simulatedState` for static focus/hover (docs-only).
