...
| Any | Disabled | `var(--color-background-gray-light)` (both unselected and selected) | `var(--color-border-disabled)` | selected dot in `var(--color-icon-disabled)`; unselected none | `var(--color-text-disabled)` |
