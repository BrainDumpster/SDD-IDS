...
|------|-----|----------|-------|
| asset | `iconSlug` → `assets/icons/calendar-simple-16.svg` | optional | From existing Asset resolution / iconSlug mentions. Not an Icon peer unless a `component` row is added. |
