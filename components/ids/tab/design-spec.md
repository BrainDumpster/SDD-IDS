...
|---|---|---|---|---|
| Primary | Selected | host-dependent (`transparent` or `var(--color-background-surface-secondary)`) | side divider `var(--color-border-gray-neutral-base)` + top indicator `2px var(--color-border-brand-strong)`; **no accessible bottom baseline** (`border-bottom: none`) | `var(--color-text-brand-strong)` |
...
| Secondary | Selected | host-dependent (`transparent` or `var(--color-background-surface-secondary)`) | bottom indicator `2px var(--color-border-brand-strong)`; **no accessible bottom baseline** (`border-bottom: none`) | `var(--color-text-brand-strong)` |
