...
- **Figma (validated):** `https://www.figma.com/design/rr8F0NGA6RNY9Z0cNeh3jh/IDS-AI-Design-Library--Test-?node-id=9838-27827&m=dev`
- **Figma file key:** `rr8F0NGA6RNY9Z0cNeh3jh`
- **Validated node id:** `9838:27827` (`primary/secondary component set`)
...
- **Validated Figma node:** `9838:27827` (IDS-AI Design Library, primary/secondary tab component set).
- **Figma MCP evidence:** `get_design_context(fileKey=rr8F0NGA6RNY9Z0cNeh3jh,nodeId=9838:27827)`, `get_variable_defs(fileKey=rr8F0NGA6RNY9Z0cNeh3jh,nodeId=9838:27827)`.
