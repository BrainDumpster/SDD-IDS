...
- Spec path: `components/ids/button/design-spec.mdx`
...
- Focus ring geometry (focus-visible):
  - outer ring stroke: `1px` (`var(--border-width-border-default)`)
  - ring offset from control edge: `3px`
  - ring corner radius: `4px` (outer ring only; button container `4px` to match Figma)
...
- Per-slot style contract:
  - `ButtonRoot`: height, padding, border, background, and typography from tokens and size contract; corner radius **`var(--corner-radius-radius-4)`** (Figma component instances, e.g. `9662:25504`).
...
- Primary node: `9662:25120` (IDS-AI button component + states).
...
- Figma MCP calls used:
  - `get_design_context(fileKey=rr8F0NGA6RNY9Z0cNeh3jh,nodeId=9662:25120)`
  - `get_design_context(fileKey=rr8F0NGA6RNY9Z0cNeh3jh,nodeId=41894:116319)`
  - `get_variable_defs(fileKey=rr8F0NGA6RNY9Z0cNeh3jh,nodeId=9662:25120)`
