...
- **Design System:** IDS
- **Figma (validated):** `https://www.figma.com/design/VZJ48bbVYrIynw8DdSukWw/-Exploration-only--IDS-with-variables?node-id=8218-13149&m=dev`
- **Node ID:** `8218:13149` (frame `SegmentedButton-Main`)
...
- **Backgrounds:** `var(--color-background-component)`, `var(--color-background-controls-brand-base)`, `var(--color-background-controls-brand-lighter)`, `var(--color-background-controls-brand-light)`.
...
| Unselected | Hover | `var(--color-background-controls-brand-lighter)` | `var(--border-width-border-1)` solid **transparent** | `var(--color-text-neutral)` |
| Unselected | Press | `var(--color-background-controls-brand-light)` | `var(--border-width-border-1)` solid **transparent** | `var(--color-text-brand-strong)` |
...
| Unselected | Hover | `var(--color-background-controls-brand-lighter)` | `var(--border-width-border-1)` solid **transparent** | `var(--color-icon-brand-base)` |
| Unselected | Press | `var(--color-background-controls-brand-light)` | `var(--border-width-border-1)` solid **transparent** | `var(--color-icon-brand-base)` |
...
| Unselected | Hover | `var(--color-background-controls-brand-lighter)` (Figma `9015:22164` Option 2 Hover) | `var(--border-width-border-1)` solid **transparent** | `var(--color-text-neutral)` / `var(--color-icon-brand-base)` |
| Unselected | Press | `var(--color-background-controls-brand-light)` | `var(--border-width-border-1)` solid **transparent** | `var(--color-text-brand-strong)` / `var(--color-icon-brand-base)` |
...
## Source Mapping
- **Primary Figma frame:** `SegmentedButton-Main` — `8218:13149`
- **Component map:** `data/component-figma-map.json` → **Segmented Button** (`nodeId` `8218-13149`, URL aligned with this spec)
- **Nested referenced in Dev Mode output:** `.SegementedButton-Element-OptionText` (`10148:29600`), `.SegementedButton-Element-OptionIcon` (`10148:29576`), `.SegementedButton-Element-Icons` (`10148:29563`)
- **Extraction method:** Figma MCP `get_metadata` + `get_design_context` on `8218:13149` (validated 2026-04-06).
