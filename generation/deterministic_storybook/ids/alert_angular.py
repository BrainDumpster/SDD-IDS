...
from generation.deterministic_storybook.story_model import build_alert_story_model
from validation.spec_contract_parser import SpecContract


def generate_ids_alert_story_angular(
    *,
    repo_root: Path,
    story_path: Path,
    ...
    model = build_alert_story_model(options=options)
    return emit_angular_csf(
        model=model,
        component_import_path="./ids-alert.component",
        component_class_name="IdsAlertComponent",
        docs_description=(
