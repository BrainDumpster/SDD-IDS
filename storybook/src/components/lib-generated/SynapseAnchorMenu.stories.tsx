/**
 * Storybook: design-spec–generated Anchor Menu from `lib/react/synapse/anchor-menu`
 ...
 * Spec: components/synapse/anchor-menu/design-spec.md
 */
import React, { type ComponentProps } from "react";
import type { Meta, StoryObj } from "@storybook/react";
import "../../../../components/synapse-theme.css";
import {
  SYNAPSE_ANCHOR_MENU_DOCS_DESCRIPTION,
  SYNAPSE_ANCHOR_MENU_SOURCE_CODE,
} from "./synapse-anchor-menu.developer-usage";
import {
  SynapseAnchorMenu,
  type SynapseAnchorMenuItem,
} from "@synapse/react/anchor-menu";

const DESIGN_SPEC_PATH = "components/synapse/anchor-menu/design-spec.md";

/** Figma `AnchorMenu-Example` (`11955:229709`) — first section selected. */
const specAccurateItems: SynapseAnchorMenuItem[] = [
...
const specAccurateArgs: ComponentProps<typeof SynapseAnchorMenu> = {
...
const meta: Meta<typeof SynapseAnchorMenu> = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: SYNAPSE_ANCHOR_MENU_DOCS_DESCRIPTION,
      },
      source: {
        type: "code",
        language: "tsx",
        code: SYNAPSE_ANCHOR_MENU_SOURCE_CODE,
      },
    },
  },
