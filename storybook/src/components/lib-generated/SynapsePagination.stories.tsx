/**
 * Storybook: design-spec–generated Pagination from `lib/react/synapse/pagination`
 ...
 *
 * Composition: lib `SynapseIcon` (nav 16×16, caret 10×10).
 * Theme: components/synapse-theme.css
 * Spec: components/synapse/pagination/design-spec.md
 */
import React, { useEffect, useRef, useState } from "react";
import type { Meta, StoryObj } from "@storybook/react";
import "../../../../components/synapse-theme.css";
import {
  SYNAPSE_PAGINATION_DOCS_DESCRIPTION,
  SYNAPSE_PAGINATION_SOURCE_CODE,
} from "./synapse-pagination.developer-usage";
import {
  SynapsePagination,
  type SynapsePaginationProps,
} from "@synapse/react/pagination";

const DESIGN_SPEC_PATH = "components/synapse/pagination/design-spec.md";

/** Main row sample — Figma `11677:157848` / page navigation `11677:157817`. */
const specAccurateArgs: SynapsePaginationProps = {
  currentPage: 2,
  totalPages: 16,
  pageSize: 25,
...
function ControlledPagination(
  props: Omit<SynapsePaginationProps, "onPageChange" | "onPageSizeChange"> & {
    onPageChange?: SynapsePaginationProps["onPageChange"];
    onPageSizeChange?: SynapsePaginationProps["onPageSizeChange"];
  },
) {
  const {
...
function OpenPerPageMenuDemo(props: SynapsePaginationProps) {
...
const meta: Meta<SynapsePaginationProps> = {
  tags: ["autodocs"],
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: SYNAPSE_PAGINATION_DOCS_DESCRIPTION,
      },
      source: {
        type: "code",
        language: "tsx",
        code: SYNAPSE_PAGINATION_SOURCE_CODE,
      },
    },
  },
...
export default meta;
type Story = StoryObj<SynapsePaginationProps>;
...
export const Disabled: Story = {
  ...
  render: () => (
    <div style={frameStyle}>
      <SynapsePagination {...specAccurateArgs} disabled />
    </div>
  ),
};
