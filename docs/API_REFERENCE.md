...
**Server**: `design-validator`

#### validate_design_tool(component, code)

Validates UI code against design system rules.

**Parameters**:
- `component` (string): Component name
- `code` (string): Code content to validate
...
**Server**: `design-component-generator`

#### generate_component(component, description, framework, style_mode)

Generates production-ready UI component aligned with design system.

**Parameters**:
- `component` (string): Component name
- `description` (string): Natural language description
- `framework` (string): "React" or "Angular" (default: "React")
- `style_mode` (string): "css-module", "css-in-js", "angular-scss" (default: "css-module")

**Returns**: Generated component with validation report
